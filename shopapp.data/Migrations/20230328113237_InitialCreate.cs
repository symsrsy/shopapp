    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Güneş Panelleri", "gunes-panelleri" },
                    { 2, "Solar İnverterler", "solar-inverterler" },
                    { 3, "Solar Jel Akü Lityum Aküler", "akuler" },
                    { 4, "Solar Şarj Kontrol Cihazları", "sarj-kontrol" },
                    { 5, "Solar Taşıyıcı Sistemler", "tasiyici-sistemler" },
                    { 6, "Solar Aydınlatma Ürünleri", "aydinlatma" },
                    { 7, "Solar Kablo ve MC4 Konnektörler", "kablo-konnektor" },
                    { 8, "Solar Sulama Sistemleri", "sulama-sistemleri" },
                    { 9, "Solar Paket Sistemleri ", "paket-sistemleri" },
                    { 10, "Elektrikli Araç Şarj İstasyonu", "arac-sarj" },
                    { 11, "Solar Ürünler", "solar-urunler" }
                });
