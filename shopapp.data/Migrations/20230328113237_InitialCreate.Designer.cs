...
namespace shopapp.data.Migrations
{
    ...
    [Migration("20230328113237_InitialCreate")]
            ...
            modelBuilder.Entity("shopapp.entity.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            CategoryId = 2,
                            Name = "Solar İnverterler",
                            Url = "solar-inverterler"
                        },
                        new
                        {
                            CategoryId = 3,
                            Name = "Solar Jel Akü Lityum Aküler",
                            Url = "akuler"
                        },
                        new
                        {
                            CategoryId = 4,
                            Name = "Solar Şarj Kontrol Cihazları",
                            Url = "sarj-kontrol"
                        },
                        new
                        {
                            CategoryId = 5,
                            Name = "Solar Taşıyıcı Sistemler",
                            Url = "tasiyici-sistemler"
                        },
                        new
                        {
                            CategoryId = 6,
                            Name = "Solar Aydınlatma Ürünleri",
                            Url = "aydinlatma"
                        },
                        new
                        {
                            CategoryId = 7,
                            Name = "Solar Kablo ve MC4 Konnektörler",
                            Url = "kablo-konnektor"
                        },
                        new
                        {
                            ...
                            Url = "sulama-sistemleri"
                        },
                        new
                        {
                            CategoryId = 9,
                            Name = "Solar Paket Sistemleri ",
                            Url = "paket-sistemleri"
                        },
                        new
                        {
                            CategoryId = 10,
